...
type Pillar = {
  title: string;
  subtitle: string;
  blurb: React.ReactNode; // allows JSX
  bg: string;
  href: string;
  points: string[];
  hasArt?: boolean;
  ...
  return (
    <Link
      ...
      className={[
        ...
        "shadow-[14px_10px_36px_-10px_rgba(34,197,94,0.32)]",
        "hover:shadow-[18px_14px_48px_-12px_rgba(34,197,94,0.42)] hover:-translate-y-1",
        ...
        <div className="mt-auto pt-8">
          {p.hasArt ? (
            <div className="relative mt-2 overflow-hidden rounded-xl border border-black/10 bg-white/45 p-4">
              <svg viewBox="0 0 640 220" className="h-28 w-full opacity-80" role="img" aria-label="A gentle path illustration">
                <path
