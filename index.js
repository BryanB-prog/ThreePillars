// app/page.tsx
// Sentropy — Modern / Data Humanism homepage
// Tailwind CSS assumed. Works in Next.js App Router.
...
const pillars: Pillar[] = [
  {
    title: "Science",
    subtitle: "Rigor, clarity, evidence",
    blurb:
      "Methods grounded in careful reasoning, reproducibility, and honest uncertainty.",
    bg: "bg-[#EEF4E8]",
    href: "/science",
    points: [
  ...
  },
  {
    ...
    subtitle: "Ethics as a design constraint",
    blurb:
      "Powerful systems need restraint: consent, dignity, fairness, and accountability.",
    bg: "bg-[#E6F2EA]",
    href: "/ethics",
    points: [
  ...
  },
  {
    ...
    subtitle: "Human flourishing",
    blurb:
      "Data should help people live better lives—more understanding, less noise, more care.",
    bg: "bg-[#DFF0D8]",
    href: "/meaning",
    points: [
...
function PillarCard({ p, index }: { p: Pillar; index: number }) {
  // Slightly different heights on desktop to echo your reference’s visual rhythm
  const heightClass =
    index === 0
      ? "md:h-[520px]"
      : index === 1
        ...
        <div className="mt-auto pt-8">
          {p.hasArt ? (
            <div className="relative mt-2 overflow-hidden rounded-xl border border-black/10 bg-white/45 p-4">
              {/* Lightweight inline “illustration” placeholder (no external assets) */}
              <svg
                viewBox="0 0 640 220"
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] text-[#1F2328]">
      ...
      <header className="sticky top-0 z-50 border-b border-black/10 bg-[#FAFAF7]/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <Link href="/" className="group inline-flex items-baseline gap-2">
            <span className="font-serif text-xl tracking-wide">Sentropy</span>
      ...
      <main>
        ...
        <section className="mx-auto max-w-6xl px-6 pt-16 md:pt-24">
          <div className="max-w-2xl">
            <h1 className="font-serif text-4xl leading-tight tracking-wide md:text-5xl">
              Data, in service of human flourishing.
            </h1>
            <p className="mt-6 text-base leading-relaxed text-black/70 md:text-lg">
              Sentropy is a portfolio and lab for ethical data science—where rigor,
              moral clarity, and meaning come first.
            </p>
        ...
        {/* Pillars (matches your reference layout) */}
        ...
        <section className="mx-auto max-w-6xl px-6 pb-20">
          <div className="rounded-3xl border border-black/10 bg-white/55 p-8 md:p-10">
            <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
              <div>
                <h2 className="font-serif text-3xl tracking-wide">Wri
